...
ConditionBlockDiagramTool::ConditionBlockDiagramTool(int cx, int cy, const Texture &bg, const Texture &state, BlockDiagramSetting &settings):
BlockDiagramTool(cx, cy, bg, state, settings), bgDrawingProgram(ResourceProvider::GetProvider().GetDrawConditionDiagramBgProgram()){
